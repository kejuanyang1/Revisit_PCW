...
def get_tokenizer(args=None, *, tokenizer_type=None, outer_tokenizer=None):
    ...
    if tokenizer_type.startswith('cogview'): # or cogview_ICE
        ...
        from .hf_tokenizer import HFT5Tokenizer, HFGPT2Tokenizer
        cache_dir = None
        ...
        elif args.tokenizer_type == "hf_GPT2Tokenizer":
            get_tokenizer.tokenizer = HFGPT2Tokenizer(args.tokenizer_model_type, cache_dir=cache_dir)
        else:
